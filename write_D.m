...
%
% You set which floats to operate on etc. in INIT_DMQC. No editing in this file!
%
% ------------------------------------------------------------------------------
%
...
for I=1:length(download_dir)	% Loop floats
  ...
  load([calib_dir,'calseries_',float_names{I}]); % settings for OWC
	% breaks                0x0                  0  double              
	% calib_profile_no      1x113              904  double              
	% calseries             1x113              904  double              
	% max_breaks            1x1                  8  double              
	% use_percent_gt        1x1                  8  double              
	% use_pres_gt           0x0                  0  double              
	% use_pres_lt           0x0                  0  double              
	% use_theta_gt          0x0                  0  double              
	% use_theta_lt          0x0                  0  double              
	% Needed for both ascendiing and descending case.
	
  load([calib_dir,'cal_',float_names{I}]);	% results of OWC
	% PROFILE_NO               1x113                904  double              
	% cal_COND              2500x113            2260000  double              
	% cal_COND_err          2500x113            2260000  double              
	% cal_SAL               2500x113            2260000  double  [√]            
	% cal_SAL_err           2500x113            2260000  double  [√]            
	% fbreaks                  0x0                    0  double              
	% fcoef                    1x1                    8  double              
	% pcond_factor             1x113                904  double              
	% pcond_factor_err         1x113                904  double              
	% sta_SAL               2500x113            2260000  double              
	% sta_SAL_err           2500x113            2260000  double              
	% sta_mean                 1x113                904  double              
	% sta_rms                  1x113                904  double              
	% time_deriv               1x113                904  double              
	% time_deriv_err           1x113                904  double              
	% Needed for both ascendiing and descending case.
  ...
  switch direction{II}
   ...
   case 'D'
    ...
    pcond_factor_err(ia)=pcond_factor_err_a(ib);% Assign the corresponding pcond_factor numbers 
    clear *_a ia ib
  ...
  load(['savedflags_',float_names{I}],'*qcn','*qco');
	% JULDqcn        1x17               34  char               
	% JULDqco        1x17               34  char               
	% POSqcn         1x17               34  char               
	% POSqco         1x17               34  char               
	% PRESqcn      700x17            23800  char               
	% PRESqco      700x17            23800  char               
	% PSALqcn      700x17            23800  char               
	% PSALqco      700x17            23800  char               
	% TEMPqcn      700x17            23800  char               
	% TEMPqco      700x17            23800  char               
