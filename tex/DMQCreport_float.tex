...
following reference databases: \small{{\verbatiminput{refdir}}} Reference
...
% \begin{figure}[H]
%   \centering    
%   \includegraphics[width=\textwidth,natwidth=1500,natheight=750]{\floatsource\WMOnum_PRES.png}
