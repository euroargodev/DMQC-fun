...
% FOR Argo DMQC.
%
% First, ownload and unpack DMQC reference data:
% cd ~/Downloads/DMQC/
...
% WMO-squares of chosen area to populate:
...
% Target directories:
dadir = '~/Arkiv/data/matlabow/';
tardir={'~/Arkiv/data/matlabow/climatology/historical_ctd', ... 
	'~/Arkiv/data/matlabow/climatology/historical_bot', ...
	'~/Arkiv/data/matlabow/climatology/argo_profiles'};
tartyp={'ctd_','bot_','argo_'};


% ----- Make a overview map of selected and ingested WMO-squares -----
